...
function AdminDataProvider({ children }) {
    ...
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[fetchData]": async ()=>{
            ...
            try {
                ...
                teamsSnapshot.forEach({
                    "AdminDataProvider.useCallback[fetchData]": (doc)=>{
                        teamsData[doc.id] = {
                            id: doc.id,
                            ...doc.data()
                        };
                    }
                }["AdminDataProvider.useCallback[fetchData]"]);
                setTeams(teamsData);
                // Fetch Players
                ...
                const playersData = playersSnapshot.docs.map({
                    "AdminDataProvider.useCallback[fetchData].playersData": (doc)=>({
                            id: doc.id,
                            ...doc.data()
                        })
                }["AdminDataProvider.useCallback[fetchData].playersData"]);
                ...
                const matchesData = matchesSnapshot.docs.map({
                    "AdminDataProvider.useCallback[fetchData].matchesData": (doc)=>{
                        const data = doc.data();
                        ...
                        const hydratedMatch = {
                            ...
                            teamA: teamA,
                            teamB: teamB,
                            rosterA: playersData.filter({
                                "AdminDataProvider.useCallback[fetchData].matchesData": (p)=>p.teamId === data.teamA.id
                            }["AdminDataProvider.useCallback[fetchData].matchesData"]),
                            rosterB: playersData.filter({
                                "AdminDataProvider.useCallback[fetchData].matchesData": (p)=>p.teamId === data.teamB.id
                            }["AdminDataProvider.useCallback[fetchData].matchesData"]),
                            events: data.events.map({
                                "AdminDataProvider.useCallback[fetchData].matchesData": (event)=>{
                                    if (event.type === 'goal') {
                                        return {
                                            ...event,
                                            scorer: playersData.find({
                                                "AdminDataProvider.useCallback[fetchData].matchesData": (p)=>p.id === event.scorer.id
                                            }["AdminDataProvider.useCallback[fetchData].matchesData"]),
                                            assist: event.assist ? playersData.find({
                                                "AdminDataProvider.useCallback[fetchData].matchesData": (p)=>p.id === event.assist.id
                                            }["AdminDataProvider.useCallback[fetchData].matchesData"]) : undefined
                                        };
                                    }
                                    if (event.type === 'penalty') {
                                        return {
                                            ...event,
                                            player: playersData.find({
                                                "AdminDataProvider.useCallback[fetchData].matchesData": (p)=>p.id === event.player.id
                                            }["AdminDataProvider.useCallback[fetchData].matchesData"])
                                        };
                                    }
                                    return event;
                ...
                }["AdminDataProvider.useCallback[fetchData].matchesData"]).filter({
                    "AdminDataProvider.useCallback[fetchData].matchesData": (m)=>m !== null
                }["AdminDataProvider.useCallback[fetchData].matchesData"]);
...
_s(AdminDataProvider, "MFa1936tCSVzoYTy+yFABDGZURI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_83e2cd60._.js.map