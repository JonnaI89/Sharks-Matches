...
function AdminDataProvider({ children }) {
    ...
    const [rawMatches, setRawMatches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDataProvider.useEffect": ()=>{
            const handleError = {
                "AdminDataProvider.useEffect.handleError": (error, type)=>{
                    ...
                    setLoadingStatus({
                        "AdminDataProvider.useEffect.handleError": (s)=>({
                                ...s,
                                [type.toLowerCase()]: false
                            })
                    }["AdminDataProvider.useEffect.handleError"]);
                }
            }["AdminDataProvider.useEffect.handleError"];
            const unsubTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "teams"), {
                "AdminDataProvider.useEffect.unsubTeams": (snapshot)=>{
                    const teamsData = {};
                    snapshot.forEach({
                        "AdminDataProvider.useEffect.unsubTeams": (doc)=>{
                            teamsData[doc.id] = {
                                id: doc.id,
                                ...doc.data()
                            };
                        }
                    }["AdminDataProvider.useEffect.unsubTeams"]);
                    setTeams(teamsData);
                    setLoadingStatus({
                        "AdminDataProvider.useEffect.unsubTeams": (s)=>({
                                ...s,
                                teams: false
                            })
                    }["AdminDataProvider.useEffect.unsubTeams"]);
                ...
                "AdminDataProvider.useEffect.unsubTeams": (err)=>handleError(err, "teams")
            }["AdminDataProvider.useEffect.unsubTeams"]);
            const unsubPlayers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "players"), {
                "AdminDataProvider.useEffect.unsubPlayers": (snapshot)=>{
                    const playersData = snapshot.docs.map({
                        "AdminDataProvider.useEffect.unsubPlayers.playersData": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["AdminDataProvider.useEffect.unsubPlayers.playersData"]);
                    setPlayers(playersData);
                    setLoadingStatus({
                        "AdminDataProvider.useEffect.unsubPlayers": (s)=>({
                                ...s,
                                players: false
                            })
                    }["AdminDataProvider.useEffect.unsubPlayers"]);
                }
            }["AdminDataProvider.useEffect.unsubPlayers"], {
                "AdminDataProvider.useEffect.unsubPlayers": (err)=>handleError(err, "players")
            }["AdminDataProvider.useEffect.unsubPlayers"]);
            const unsubMatches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "matches"), {
                "AdminDataProvider.useEffect.unsubMatches": (snapshot)=>{
                    setRawMatches(snapshot.docs.map({
                        "AdminDataProvider.useEffect.unsubMatches": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["AdminDataProvider.useEffect.unsubMatches"]));
                    setLoadingStatus({
                        "AdminDataProvider.useEffect.unsubMatches": (s)=>({
                                ...s,
                                matches: false
                            })
                    }["AdminDataProvider.useEffect.unsubMatches"]);
                ...
                "AdminDataProvider.useEffect.unsubMatches": (err)=>handleError(err, "matches")
            }["AdminDataProvider.useEffect.unsubMatches"]);
            return ({
                "AdminDataProvider.useEffect": ()=>{
                    unsubTeams();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDataProvider.useEffect": ()=>{
            ...
            const hydratedMatches = rawMatches.map({
                "AdminDataProvider.useEffect.hydratedMatches": (match)=>{
                    const teamA = teams[match.teamA?.id];
                    const teamB = teams[match.teamB?.id];
                    if (!teamA || !teamB) return null;
                    const hydratedEvents = (match.events || []).map({
                        "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents": (event)=>{
                            if (event.type === 'goal') {
                                const scorer = players.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.scorer": (p)=>p.id === event.scorer?.id
                                }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.scorer"]);
                                if (!scorer) return null;
                                const assist = event.assist?.id ? players.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents": (p)=>p.id === event.assist.id
                                }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents"]) : undefined;
                                return {
                                    ...event,
                                    scorer,
                            ...
                            if (event.type === 'penalty') {
                                const player = players.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.player": (p)=>p.id === event.player?.id
                                }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.player"]);
                            ...
                            if (event.type === 'save') {
                                const goalie = players.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.goalie": (p)=>p.id === event.goalie?.id
                                }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents.goalie"]);
                    ...
                    }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents"]).filter({
                        "AdminDataProvider.useEffect.hydratedMatches.hydratedEvents": (e)=>e !== null
                    }["AdminDataProvider.useEffect.hydratedMatches.hydratedEvents"]);
                    const rosterA_withStats = players.filter({
                        "AdminDataProvider.useEffect.hydratedMatches.rosterA_withStats": (p)=>p.teamId === teamA.id
                    }["AdminDataProvider.useEffect.hydratedMatches.rosterA_withStats"]).map({
                        "AdminDataProvider.useEffect.hydratedMatches.rosterA_withStats": (p)=>({
                                ...p,
                                stats: {
                                    goals: 0,
                                    assists: 0,
                    ...
                    }["AdminDataProvider.useEffect.hydratedMatches.rosterA_withStats"]);
                    const rosterB_withStats = players.filter({
                        "AdminDataProvider.useEffect.hydratedMatches.rosterB_withStats": (p)=>p.teamId === teamB.id
                    }["AdminDataProvider.useEffect.hydratedMatches.rosterB_withStats"]).map({
                        "AdminDataProvider.useEffect.hydratedMatches.rosterB_withStats": (p)=>({
                                ...p,
                                stats: {
                                    goals: 0,
                                    assists: 0,
                    ...
                    }["AdminDataProvider.useEffect.hydratedMatches.rosterB_withStats"]);
                    hydratedEvents.forEach({
                        "AdminDataProvider.useEffect.hydratedMatches": (event)=>{
                            ...
                            if (event.type === 'goal') {
                                ...
                                const scorer = scorerRoster.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.scorer": (p)=>p.id === goalEvent.scorer.id
                                }["AdminDataProvider.useEffect.hydratedMatches.scorer"]);
                                if (scorer) scorer.stats.goals += 1;
                                if (goalEvent.assist) {
                                    const assistRoster = isTeamAEvent ? rosterA_withStats : rosterB_withStats;
                                    const assister = assistRoster.find({
                                        "AdminDataProvider.useEffect.hydratedMatches.assister": (p)=>p.id === goalEvent.assist.id
                                    }["AdminDataProvider.useEffect.hydratedMatches.assister"]);
                                ...
                                if (goalEvent.concedingGoalieId) {
                                    ...
                                    const goalie = concedingRoster.find({
                                        "AdminDataProvider.useEffect.hydratedMatches.goalie": (p)=>p.id === goalEvent.concedingGoalieId
                                    }["AdminDataProvider.useEffect.hydratedMatches.goalie"]);
                                    if (goalie) {
                                ...
                                const player = penaltyRoster.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.player": (p)=>p.id === event.player.id
                                }["AdminDataProvider.useEffect.hydratedMatches.player"]);
                                ...
                                const goalie = savingRoster.find({
                                    "AdminDataProvider.useEffect.hydratedMatches.goalie": (p)=>p.id === saveEvent.goalie.id
                                }["AdminDataProvider.useEffect.hydratedMatches.goalie"]);
                                if (goalie) {
                    ...
                    }["AdminDataProvider.useEffect.hydratedMatches"]);
                    const hydratedMatch = {
                        ...match,
                        teamA,
                        teamB,
            ...
            }["AdminDataProvider.useEffect.hydratedMatches"]).filter({
                "AdminDataProvider.useEffect.hydratedMatches": (m)=>m !== null
            }["AdminDataProvider.useEffect.hydratedMatches"]);
    ...
    const addMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[addMatch]": async (teamAId, teamBId, totalPeriods, periodDurationMinutes, breakDurationMinutes, goalieAId, goalieBId)=>{
            ...
            const newMatchData = {
                ...
                breakEndTime: null,
                events: [],
                rosterA: players.filter({
                    "AdminDataProvider.useCallback[addMatch]": (p)=>p.teamId === teamAId
                }["AdminDataProvider.useCallback[addMatch]"]),
                rosterB: players.filter({
                    "AdminDataProvider.useCallback[addMatch]": (p)=>p.teamId === teamBId
                }["AdminDataProvider.useCallback[addMatch]"]),
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "matches"), sanitizedMatch);
            } catch (error) {
    ...
    const deleteMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[deleteMatch]": async (matchId)=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "matches", matchId));
            } catch (error) {
                console.error("Error deleting match: ", error);
            }
        }
    }["AdminDataProvider.useCallback[deleteMatch]"], []);
    const addTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[addTeam]": async (newTeam)=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "teams"), newTeam);
            } catch (error) {
                console.error("Error adding team: ", error);
            }
        }
    }["AdminDataProvider.useCallback[addTeam]"], []);
    const updateTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[updateTeam]": async (teamId, teamData)=>{
            try {
                const teamDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "teams", teamId);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(teamDocRef, teamData);
            } catch (error) {
    ...
    }["AdminDataProvider.useCallback[updateTeam]"], [
        toast
    ]);
    const deleteTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[deleteTeam]": async (teamId)=>{
            if (players.some({
                "AdminDataProvider.useCallback[deleteTeam]": (p)=>p.teamId === teamId
            }["AdminDataProvider.useCallback[deleteTeam]"])) {
                toast({
            ...
            if (matches && matches.some({
                "AdminDataProvider.useCallback[deleteTeam]": (m)=>m.teamA.id === teamId || m.teamB.id === teamId
            }["AdminDataProvider.useCallback[deleteTeam]"])) {
                toast({
                    title: "Cannot Remove Team",
    ...
    const addPlayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[addPlayer]": async (teamId, newPlayer)=>{
            const playerToAdd = {
                ...newPlayer,
                teamId: teamId,
                stats: {
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "players"), playerToAdd);
            } catch (e) {
                console.error("Error adding player: ", e);
            }
        }
    }["AdminDataProvider.useCallback[addPlayer]"], []);
    const deletePlayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDataProvider.useCallback[deletePlayer]": async (playerId)=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "players", playerId));
            } catch (e) {
                console.error("Error deleting player: ", e);
            }
        }
    }["AdminDataProvider.useCallback[deletePlayer]"], []);
    const value = {
        matches: matches || [],
        teams,
        players,
...
_s(AdminDataProvider, "y1AkVI5J4gCNcvk31IZFELeuYkc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_ee11c723._.js.map